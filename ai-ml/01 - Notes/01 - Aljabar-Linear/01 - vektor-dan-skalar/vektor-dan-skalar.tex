...
\lhead{Catatan Pembelajaran}
\rfoot{Halaman \thepage}
\renewcommand{\headrulewidth}{0.4pt}

% Improved definition and example environments to prevent hbox warnings
...
\subsection{Skalar}
\begin{definition}{Definisi Skalar}
...
\subsection{Vektor}
\begin{definition}{Definisi Vektor}
...
\begin{example}{Contoh Vektor 2D dan 3D}
...
\begin{example}{Contoh Operasi Vektor dan Skalar}
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        1 \\
        2 \\
...
\begin{definition}{Penjumlahan dan Pengurangan Vektor}
Jika:
\begin{equation}
...
\begin{example}{Contoh Operasi Dua Vektor}
\begin{equation}
    \mathbf{u} = \begin{bmatrix}
        1 \\
        2 \\
...
\begin{definition}{Perkalian Skalar dengan Vektor}
...
\begin{example}{Contoh Perkalian Skalar dengan Vektor}
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        2 \\
        3 \\
...
\begin{example}{Contoh Dot Product}
\begin{equation}
    \mathbf{u} = \begin{bmatrix}
        1 \\
        2 \\
...
\begin{definition}{Cross Product (3D)}
...
\begin{example}{Contoh Cross Product}
\begin{equation}
    \mathbf{u} = \begin{bmatrix}
        1 \\
        2 \\
...
\begin{definition}{Definisi Norma Vektor}
...
\begin{definition}{Norma-2 (Euclidean)}
...
\begin{definition}{Norma Tak Hingga}
Didefinisikan sebagai:
\begin{equation}
...
\begin{example}{Contoh Norma Tak Hingga}
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        -3 \\
        4 \\
...
\begin{example}{Contoh Representasi Data}
...
\begin{definition}{Sifat-Sifat Operasi Vektor}
