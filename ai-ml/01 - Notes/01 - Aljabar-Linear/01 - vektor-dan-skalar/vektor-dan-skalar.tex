...
% Simple definition and example environments using sections instead of tcolorbox
\newcommand{\definition}[2]{\textbf{#1}\newline #2}
\newcommand{\example}[2]{\textbf{#1}\newline #2}
...
\example{Contoh Vektor 2D dan 3D}{%
...
\example{Contoh Operasi Vektor dan Skalar}{%
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        1 \\
        2 \\
...
\definition{Penjumlahan dan Pengurangan Vektor}{%
Jika:
\begin{equation}
...
\example{Contoh Operasi Dua Vektor}{%
\begin{equation}
    \mathbf{u} = \begin{bmatrix}
        1 \\
        2 \\
...
\definition{Perkalian Skalar dengan Vektor}{%
...
\example{Contoh Perkalian Skalar dengan Vektor}{%
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        2 \\
        3 \\
...
\definition{Definisi Norma Vektor}{%
...
\example{Contoh Norma Tak Hingga}{%
\begin{equation}
    \mathbf{v} = \begin{bmatrix}
        -3 \\
        4 \\
...
\example{Contoh Representasi Data}{%
...
\definition{Sifat-Sifat Operasi Vektor}{%
